...
import manifest from './AssetManifestBoot.js'
...
BasicGame.Boot.prototype = {
  ...
  create: function() {
    ...
    // load manifest for boot stage, usaually only the background part
    ...
    this.game.load.onFileComplete.add( (progress, key, success, loaded, total) => {
      //console.log("Boot complete: " + progress + "% - " + loaded + " out of " + total);
      if (loaded == total) {
